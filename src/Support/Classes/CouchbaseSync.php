...
namespace Uccello\UccelloCouchbaseSync\Support\Classes;

use Exception;
use Uccello\UccelloCouchbaseSync\Support\Contracts\CouchbaseInterface;

class CouchbaseSync implements CouchbaseInterface
{
    private $baseURI;
    private $timeout;
    private $token;
    ...
    /**
     * Writing data into Couchbase with a PUT request
     * HTTP 200: Ok
     *
     * @param string $path Path
    ...
    /**
     * Pushing data into Couchbase with a POST request
     * HTTP 200: Ok
     *
     * @param string $path Path
     * @param mixed $data Data
    ...
    /**
     * Updating data into Couchbase with a PATH request
     * HTTP 200: Ok
     *
     * @param string $path Path
     * @param mixed $data Data
